...
<c:set var = "pageTitle" scope = "session" value = "${'Furniture Work'}"/>
</head>
<body>
	...
	<div id="content-wrapper">
		<div class="container-fluid">
			...
			<div class="fn-form">
				<h3>Add New Furniture Work Image</h3>
				<form action="<c:url value='furniture-work'/>" method="post"
					...
					<div class="form-group col-md-3">
						<label for="file">Image</label> <input type="file"
							class="form-control-file" id="fnWorkFile" name="file">
					</div>
	...
	<script type="text/javascript">
		...
		// document ready started
			...
			$('#table tbody').on('change', 'td select', function (){
		        ...
		        $.ajax({
		        	'url':'/furniture-work/'+ data_row.id + '?status=' + $(this).val(),
		        	'method':'PATCH',
			...
			$('#table tbody').on('click', 'td button', function (){
		        ...
		        //console.log(data_row);
		        $.ajax({
		        	'url':'/furniture-work/'+ data_row.id,
		        	'method':'DELETE',
		        	'contentType': 'application/json',
		        	 success: function (data,status,xhr) {
		        		 $table.ajax.reload();
